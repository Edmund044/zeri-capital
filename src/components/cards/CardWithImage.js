              ...
              contents.map((content,index,array)=>{
                return (
                  ...
                  <div className="lg:p-0">
                    <h5 className="mb-2 text-2xl ml-0 font-heading font-bold tracking-tight text-gray-900 dark:text-white">{content.name}</h5>
                  <p className="mb-3 font-normal ml-0 font-heading text-gray-700 dark:text-gray-400">{content.title}</p>
