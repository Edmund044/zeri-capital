...
<div className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-24">
  <div className="text-center">
    <h1 className=" mb-4 text-3xl lg:text-4xl font-heading font-bold font-heading md:text-5xl xl:text-5xl text-center">{props.heading}</h1>

    <p className="mb-6 font-body ml-2 text-xl font-body lg:text-3xl lg:mb-8 ">
      {props.subheading1}
    </p>
    <p className="mb-6 font-body ml-2 text-xl font-body lg:text-3xl lg:mb-8 ">
      {props.subheading2}
