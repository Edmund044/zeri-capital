          ...
          <div className="mt-8 lg:mx-24 bg-background grid grid-cols-1 lg:gap-8 md:grid-cols-2 lg:grid-cols-3">
            {
              teamMembers.map((teamMember,index,array)=>{
                return (
                  ...
                  />
                  <div className="p-5">
                    <h5 className="mb-2 text-2xl font-bold font-heading tracking-tight text-gray-900 dark:text-white">{teamMember.name}</h5>
                  <p className="mb-3 font-normal text-gray-700 font-body dark:text-gray-400">{teamMember.title}</p>
                  </div>
                  </div>
