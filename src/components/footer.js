...
export default function Footer() {
    return ( 
        <main className="">
<footer className="bg-accent bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')]" aria-labelledby="footer-heading">
  ...
  <path d="M2.75 2a.75.75 0 0 0-.75.75v10.5a.75.75 0 0 0 1.5 0v-2.624l.33-.083A6.044 6.044 0 0 1 8 11c1.29.645 2.77.807 4.17.457l1.48-.37a.462.462 0 0 0 .35-.448V3.56a.438.438 0 0 0-.544-.425l-1.287.322C10.77 3.808 9.291 3.646 8 3a6.045 6.045 0 0 0-4.17-.457l-.34.085A.75.75 0 0 0 2.75 2Z" />
      ...
      <div className="mt-16 grid grid-cols-2 gap-10 xl:col-span-2 xl:mt-0">
        ...
        {/* <div className="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 className="text-sm font-semibold leading-6 text-gray-900 font-heading">Company</h3>
            <ul role="list" className="mt-6 space-y-4">
              <li>
          ...
          <div className="mt-10 md:mt-0">
            <h3 className="text-sm font-semibold leading-6 text-gray-900 font-heading">Legal</h3>
            <ul role="list" className="mt-6 space-y-4">
              <li>
