...
<footer className="bg-cover bg-no-repeat bg-[url('/images/gtc.jpeg')] bg-gray-700 bg-blend-multiply">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:pt-24">
        <div className="md:flex mb-24 md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="" className="flex items-center">
                  <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 me-3" alt="FlowBite Logo" />
                  <span className="self-center lg:text-4xl text-2xl text-white font-semibold whitespace-nowrap dark:text-white">Zeri Capital</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-4 sm:gap-6 sm:grid-cols-4">
              ...
              <div>
                  <h2 className="mb-6 text-4xl font-semibold text-white  dark:text-white"></h2>
                  <ul className="text-white dark:text-gray-400 font-medium">
                      <li className="mb-4">
              ...
              <div>
                  <h2 className="mb-6 text-2xl font-semibold text-white  dark:text-white"></h2>
                  <ul className="text-white dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:underline"></a>
                      </li>
      ...
      <div className="sm:flex sm:items-center mb-16 sm:justify-between">
          <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2024 Zeri Capital. All Rights Reserved.
          </span>
