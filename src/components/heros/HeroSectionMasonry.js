...
export default function HeroSectionMasonry(){
    ...
    return(
        ...
        <div className="absolute w-full h-full rounded-xl text-white">
              <h1 className="font-bold font-heading text-5xl pl-4 pt-16">JITAHIDI PROGRAMME</h1>
              <p className="font-normal font-body text-3xl pl-4 ">Still in University</p>
            </div>
        ...
        <a onClick={() => router.push('/career_')}>
            ...
            <div onClick={() => router.push('/career_')}>
            <div className="absolute w-full h-full rounded-xl text-white">
              <h1 className="font-bold font-heading text-5xl w-5/12 pl-4 pt-16">GRADUATE ANALYST PROGRAMME</h1>
              <p className="font-normal font-body text-3xl pl-4">0 - 2 years</p>
            </div>
            <a onClick={() => router.push('/career_')}>
        ...
        <div onClick={() => router.push('/career_')} className="absolute w-full h-full rounded-xl text-white">
              <h1 className="font-bold font-heading text-5xl  w-5/12  pl-4 pt-16">EXPERIENCED PROFESSIONALS</h1>
              <p className="font-normal font-body text-3xl pl-4">3+ years</p>
            </div>
        <a onClick={() => router.push('/career_')}>
