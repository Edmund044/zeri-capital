    ...
    return (
        ...
        <section className="bg-background">
            ...
            {(() => {
                if (props.type == '1') {
                  return (
                    <section class="bg-cover bg-no-repeat bg-[url('/images/gtc.jpeg')] bg-gray-800 bg-blend-multiply">
                    <div class="px-4 w-5/12 ml-12 py-24 lg:py-32">
                        ...
                        <p class="mb-4 text-xl font-normal text-white md:text-5xl lg:text-xl">{props.description}</p>
                  ...
                  return (
                    ...
                    <section class="bg-center bg-no-repeat bg-[url('/images/gtc.jpeg')] bg-accent bg-blend-multiply">
