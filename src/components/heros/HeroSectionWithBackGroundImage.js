                ...
                if (props.type == '1') {
                  return (
                    ...
                    <div className="px-4 w-5/12 ml-12 py-24 lg:py-32">
                        ...
                        <h1 className="mb-4 lg:text-5xl text-4xl font-heading font-bold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">{props.heading}</h1>
                        <p className="mb-4 text-xl font-normal font-body font-body text-white md:text-5xl lg:text-xl">{props.description}</p>
                        <button type="submit" className="text-white font-heading  bg-accent hover:bg-secondary font-medium rounded-full text-sm px-12 py-12 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{props.buttonText}</button>
                    </div>
                </section>
                  )
                  ...
                  return (
                    ...
                    <div className=" py-24 text-center lg:py-16">
                        <h1 className="mb-8 lg:text-5xl text-center font-heading text-4xl font-bold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">{props.heading}</h1>
                    ...
                    <div className="px-4 mx-auto text-center py-24 lg:py-48">
                        ...
                        <h1 className="mb-4 lg:text-5xl text-4xl font-bold font-heading tracking-tight leading-none text-white md:text-5xl lg:text-6xl">{props.heading}</h1>
                        <p className="mb-8 text-2xl ml-8 font-body font-normal text-gray-300 lg:text-4xl sm:px-16 lg:px-48">{props.description}</p>
                  ...
                  return (
                    ...
                    <div className=" py-24 text-center lg:py-48">
                        <h1 className="mb-8 lg:text-5xl text-center text-4xl font-heading font-bold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">{props.heading}</h1>
