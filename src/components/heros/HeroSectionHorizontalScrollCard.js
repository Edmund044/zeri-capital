...
<h1
      ...
      <p className="max-w-2xl lg:text-5xl text-2xl font-body mx-8 lg:mb-8 lg:mx-48">{props.subheading} </p>
      ...
      >
        <Carousel
            ...
            renderArrowPrev={(clickHandler, hasPrev) => {
              return (
                <div
                  className="flex justify-end lg:mr-20   cursor-pointer z-20"
            ...
            renderArrowNext={(clickHandler, hasNext) => {
              return (
                <div
                className="flex justify-center lg:mr-20 items-center  cursor-pointer"
                  onClick={clickHandler}
                >
                  {/* <button className="bg-white text-4xl w-9 h-9 text-accent">&rarr;</button> */}
                </div>
