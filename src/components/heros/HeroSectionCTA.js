...
<section className="bg-background">
  <div className="p-8 md:p-12 lg:px-16 lg:py-36">
    <div className="mx-auto max-w-lg text-center">
      <h2 className="text-4xl font-bold font-heading text-accent md:text-4xl">
       {props.heading}
      </h2>
    ...
    {(() => {
        if (props.type == '1') {
          return (
            <div className="mx-auto mt-8 max-w-xl bg-red-500 ">
    ...
    <div className="relative">
        <input type="search" id="search" className="block w-full p-4 ps-2 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-100 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your email" required />
